...
const cards = [
  {
    title: "Pastor Davidsam Joyson",
    desc: "Anointed messages igniting young hearts for Christ.",
    image: "/images/about/vbs.webp",
    icon: "fa-cross"
  },
  {
    title: "Dance",
    desc: "Energetic praise dances celebrating God's amazing glory.",
    image: "/images/about/dance.webp",
    icon: "fa-music"
  }
];
