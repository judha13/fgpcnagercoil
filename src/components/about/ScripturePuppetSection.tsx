...
const cards = [
  {
    title: "Bible Verse",
    desc: "Memorizing powerful scriptures to strengthen young faith.",
    image: "/images/about/bible-verse.webp",
    icon: "fa-book-bible"
  },
  {
    title: "Puppet Show",
    desc: "Fun puppet adventures teaching godly values joyfully.",
    image: "/images/about/puppet.jpg",
    icon: "fa-hand-sparkles"
  }
];

export default function ScripturePuppetSection() {
  return (
