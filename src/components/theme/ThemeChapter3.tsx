    ...
    <section className="relative z-10 h-full flex items-center justify-center py-12 md:py-4">
      <div className="container mx-auto px-6 max-w-[1400px]">
        ...
        >
          ...
          <h2 className="text-3xl md:text-6xl font-black text-white tracking-tight">Chapter Three: <span className="text-amber-400">The Victory</span></h2>
        </motion.div>
